...
namespace TestCaseEditorApp.Converters
{
    ...
    /// <summary>
    /// Converts count (int) to visibility - shows when count > 0
    /// </summary>
    ...
    /// <summary>
    /// Converts string to visibility - shows when string is not null/empty
    /// </summary>
    ...
    /// <summary>Converts boolean to visibility with inverse logic.</summary>
