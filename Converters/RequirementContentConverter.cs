...
namespace TestCaseEditorApp.Converters
{
    ...
    public class RequirementContentConverter : IValueConverter
    {
        ...
        private static UIElement? CreateReadOnlyDataGrid(LooseTable table)
        {
            ...
            // Apply the scrollable DataGrid style with proper scrollbars
            var dataGridStyle = System.Windows.Application.Current.TryFindResource("ScrollableDataGridStyle") as Style;
