...
{
    /// <summary>
    /// StartUp HeaderWorkspace ViewModel - Following AI Guide patterns
    /// </summary>
    public partial class StartUp_HeaderViewModel : BaseDomainViewModel
    {
        ...
        [ObservableProperty]
        private string subtitle = "Test Case Generation Platform";
        ...
        public StartUp_HeaderViewModel(
            ...
            ILogger<StartUp_HeaderViewModel> logger)
