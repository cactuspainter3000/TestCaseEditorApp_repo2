...
{
    /// <summary>
    /// Dummy HeaderWorkspace ViewModel - Reference implementation following AI Guide patterns
    /// Use this as a template for any domain's header area
    /// </summary>
    public partial class DummyHeaderWorkspaceViewModel : BaseDomainViewModel
    {
        ...
        public DummyHeaderWorkspaceViewModel(
            ...
            ILogger<DummyHeaderWorkspaceViewModel> logger)
