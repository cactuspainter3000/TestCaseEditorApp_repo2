...
namespace TestCaseEditorApp.MVVM.ViewModels
{
    public class TestCaseGenerator_NavigationVM : ObservableObject, IDisposable
    {
        ...
        public TestCaseGenerator_NavigationVM(ITestCaseGenerator_Navigator navigator)
        {
        ...
        private void Navigator_PropertyChanged(object? sender, PropertyChangedEventArgs e)
        {
            try
            {
                ...
                else if (e.PropertyName == nameof(ITestCaseGenerator_Navigator.RequirementPositionDisplay))
                {
                    OnPropertyChanged(nameof(RequirementPositionDisplay));
                }
                else if (e.PropertyName == nameof(ITestCaseGenerator_Navigator.WrapOnNextWithoutTestCase))
                {
